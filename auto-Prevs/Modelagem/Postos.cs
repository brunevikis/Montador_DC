...
namespace AutoPrevs.Modelagem {
    public class Postos : Model {
        ...
        /// <summary>
        /// Calcula a projeção do reservatorio dos postos para todas as semanas.
        /// </summary>
        ...
        public static void projetaPostos(IList<Postos> postosList, Semanas_Ano semanaProjecao) {
            atualizaPostosBase(postosList, semanaProjecao);
            atualizaPostosRegredidos(postosList, semanaProjecao);
            Calculados.atualizar(postosList, semanaProjecao);
        }
        ...
        public static void atualizaPostosBase(IList<Postos> postosList, Semanas_Ano semanaProjecao) {
            ...
            foreach (Postos p in postosList.Where(p => p.tipo == 0 || p.tipo == 1 || p.tipo == 2 || p.tipo == 3)) {
