...
namespace AutoPrevs.Modelagem {
    public class Calculados : Model {
        ...
        public Calculados() {
            postos = new int[] { 104, 109, 116, 169, 171, 172, 173, 175, 176, 178, 244, 37, 38, 39, 40, 42, 43, 45, 46, 66, 298, 75, 318, 317, 315, 316, 131, 132, 304, 299, 127, 126, 303, 306, 314, 319 };
        }
        ...
        public static void atualizar(IList<Postos> postosList, Semanas_Ano semanaProjecao) {
