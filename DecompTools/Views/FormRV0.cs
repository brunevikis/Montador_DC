...
namespace DecompTools.Views {
    public partial class FormRV0 : FormBasic {
        ...
        public int? RelatorioCVU {
            get {
                if (chkCVU.Checked) {
                    return (int)cbxCVUs.SelectedValue;
                } else return null;
            }
        }

        public List<DeParaNomePosto> DeParasCVU {
            get {

                _deParasTsk.Wait();
                return _deParasTsk.Result;
            }
        }
        ...
        private async void chkCVU_CheckedChanged(object sender, EventArgs e) {
            try {
                ...
                ToolBox.Messages.Error(this, ex.Message, ex, true);
            } finally {
                IsLoading = false;
                cbxCVUs.Enabled = chkCVU.Checked;
            }
        }
