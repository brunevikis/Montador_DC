namespace DecompTools.Views {
    partial class FormReservatorio {
        ...
        private void InitializeComponent() {
            ...
            this.Controls.SetChildIndex(this.dgvDeck, 0);
            this.Controls.SetChildIndex(this.label1, 0);
            this.Controls.SetChildIndex(this.txtExitPath, 0);
            this.Controls.SetChildIndex(this.btnGerar, 0);
            this.Controls.SetChildIndex(this.label2, 0);
            this.Controls.SetChildIndex(this.label3, 0);
            this.Controls.SetChildIndex(this.label4, 0);
            this.Controls.SetChildIndex(this.label5, 0);
            this.Controls.SetChildIndex(this.txtReservSE, 0);
            this.Controls.SetChildIndex(this.txtReservS, 0);
            this.Controls.SetChildIndex(this.txtReservNE, 0);
            this.Controls.SetChildIndex(this.txtReservN, 0);
            this.Controls.SetChildIndex(this.label6, 0);
            this.Controls.SetChildIndex(this.txtEarm, 0);
