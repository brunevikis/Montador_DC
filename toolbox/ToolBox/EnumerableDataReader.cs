...
namespace ToolBox {
    ...
    public class EnumerableDataReader<T> : IDataReader {
        ...
        public DataTable GetSchemaTable() {
            ...
            using (var dtr = new DataTableReader(dt)) {
                foreach (DataColumn col in dtr.GetSchemaTable().Columns) {

                    var colN = new DataColumn(col.ColumnName, col.DataType, col.Expression, col.ColumnMapping);
