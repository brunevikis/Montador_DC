...
namespace CapturaNW.Modelagem
{
    public class DeckNW : Model
    {
        ...
        public DeckNW()
        {
            blocos = new string[] { "DGER.DAT", "EXPH.DAT", "EXPT.DAT", "EAFPAST.DAT", "C_ADIC.DAT", "CLAST.DAT", "MANUTT.DAT", "TERM.DAT", "SISTEMA.DAT", "CONFT.DAT", "PATAMAR.DAT", "MODIF.DAT" };
            blocos2 = new string[] { "C_ADIC", "CLAST_1", "CLAST_2", "CONFT", "CUSTO_DEF", "DGER", "EAFPAST", "EXPH", "EXPT", "INTERCAMBIO", "MANUTT", "MERCADO", "PAT_CARGA", "PAT_INTERCAMBIO", "PEQUENA", "TERM", "MODIF" };
        }
    }
}
