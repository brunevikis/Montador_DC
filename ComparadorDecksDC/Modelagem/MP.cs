...
namespace ComparadorDecksDC.Modelagem 
{
    public class MP : blockModel
    {
        ...
        public virtual void atualizarRV0(int nSemanasAtual, int nSemanasBase)
        {
            ...
            PropertyInfo camp2 = mpT.GetType().GetProperty("campo" + (nSemanasBase + 2).ToString());
            ...
            {
                PropertyInfo camp3 = mpT.GetType().GetProperty("campo" + (nSemanasBase + 1).ToString());
                camp2.SetValue(this, camp3.GetValue(this, null), null);                                     //this.campo7 = this.campo6;
            }

            UtilitarioDeTexto.zerarDados(this, sem, 8);
