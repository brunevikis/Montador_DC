...
namespace ComparadorDecksDC.Modelagem {
    public class Dadgnl {
        ...
        public Dadgnl CreateNewMensal(int ano, int mes) {
            ...
            Semanas_Patamares patamar = Factory.SemanasPatamaresDAO.GetByPeriod(dataAtual, dataAtual.AddMonths(1).AddDays(-1));
            Semanas_Patamares patamar2 = Factory.SemanasPatamaresDAO.GetByPeriod(dataAtual.AddMonths(1), dataAtual.AddMonths(1).AddMonths(1).AddDays(-1));
    ...
    public class DadgnlFactory {
        public static Dadgnl CreatFromText(string texto, int ano, int mes, int rev) {
