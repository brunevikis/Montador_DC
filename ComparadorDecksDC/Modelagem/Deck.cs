...
namespace ComparadorDecksDC.Modelagem
{
    public class Deck : Model
    {
        ...
        public Deck()
        {
            blocos = new string[]{ "UH", "CT", "UE", "VR", "DP", "CD", "PQ", "IT", "IA", "TX", "GP", "NI", "DT", "MP", "MT", "FD", "VE", "RHE", "VI", "QI", "AC", "PI", "IR", "CI", "FC", "EA", "ES", "TI", "RQ", "EZ", "RHA", "RHV", "RHQ" };
        }
        ...
        public virtual void add(ArrayList list, String blocoAtual, int numLinha)
        {
            ...
            if (blocoAtual != "")
            {
                Type t = Type.GetType("ComparadorDecksDC.Modelagem." + blocoAtual);
                blockList = GetList(t);
        ...
        public virtual void clone(Deck deckBase, string b)
        {
            ...
            Type t = Type.GetType("ComparadorDecksDC.Modelagem." + b);
        ...
        public virtual void escreveDeck(string caminho, string nomeArquivo = null, string nomeMensal = null)
        {
            ...
            using (TextWriter arquivo = File.CreateText(caminho))
            {
                ...
                arquivo.WriteLine("AR     1    25.0  50.0");
                arquivo.WriteLine("& --------------------------------------------------------------------------------------------");
                ...
                arquivo.WriteLine("& HISTORICO DE VAZOES      - HIDROL => {NOME_ARQ_VAZOES}".Replace("{NOME_ARQ_VAZOES}", String.Concat((s.ano - 2).ToString(), " VAZOESC.DAT")));
                ...
                arquivo.WriteLine(String.Concat("& NO. SEMANAS NO MES INIC. DO ESTUDO=> ", (nomeMensal == null) ? s.semanas - this.rev : 0));
                ...
                arquivo.WriteLine("& UTILIZA AGREGACAO                 => S");
